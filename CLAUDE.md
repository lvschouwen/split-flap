...
- Copied pure headers (fix bugs in both trees): `UnitHealth.h`, `UnitProtocolHelpers.h`, `WearPolicy.h`, `TwibootProtocol.h`, `DisplayWidth.h`, `FollowerCors.h`, `ClusterHmac.h`, `UnitVitals.h`, `HeartbeatPolicy.h`, `BootHomePlan.h`, plus `FollowerOps.h` (reflash batch size 2 — bench-tuned, NOT the S3's 4).
