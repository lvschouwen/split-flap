...
/* Must keep (TIMER_IRQFREQ_MS * F_CPU) / (TIMER_DIVISOR * 1000) < 256 so it
 * fits in the 8-bit TCNT0 preload. At 16MHz that caps TIMER_IRQFREQ_MS at 16. */
#ifndef TIMER_IRQFREQ_MS
