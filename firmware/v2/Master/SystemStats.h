...
// netTask only: samples vitals every SYSTEM_STATS_FAST_INTERVAL_S. Radio
// reads (WiFi.RSSI) belong to netTask; I2C/MQTT/NTP counters are
// cross-task-safe 32-bit reads (see their accessors).
